...
// Include full absorb spell IDs from Details addon
// const ABSORB_SPELL_IDS = new Set([
//   64413, 17, 48066, 48065, 47509, 47511, 47515, 47753, 54704, 47788, // Priest
//   58597, // Paladin
//   11426, 43039, 13031, 13032, 13033, 27134, 33405, 43038, // Ice Barrier ranks
...
//   51052, 48707, 51271, // DK
//   62606, // Druid
//   7812, 19438, 19440, 19441, 19442, 19443, 27273, 47985, 47986, // Warlock Sacrifice
        ...
        for (const attempt of attempts) {
          ...
          for (const line of slicedLines) {
            ...
            if (validHealingEvents.has(eventType)) {
              ...
              actor.spellList[spellKey] = spell;
            ...
            // Track absorbs from aura applications
            if (
              ...
              if (!actor.spellList[spellKey]) {
                spell.totalCasts += 1;
                spell.healing.absorb += 0;
                actor.spellList[spellKey] = spell;
              }
            }
          }

          // Final healing stats per spell
